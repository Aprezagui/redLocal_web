 ...
 */
    ...
    function validarFormulario(evObject) {
        ...
        if (isNaN(formulario.nombre.value) == false || formulario.nombre.value.length == 0) {
        alert('El campo \"Nombre\" no esta completo o no es correcto');
        todoCorrecto = false;
        }
        
        //Comprueba el campo Apellidos
        if (isNaN(formulario.apellido1.value) == false || formulario.apellido1.value.length == 0) {
        alert('El campo \"Primer apellidos\" no esta completo o no es correcto');
        todoCorrecto = false;
        }
        
        //Comprueba el campo Apellidos
        if (isNaN(formulario.apellido2.value) == false || formulario.apellido2.value.length == 0) {
